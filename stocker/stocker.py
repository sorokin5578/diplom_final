...
class Stocker:
    ...
    def __init__(self, ticker, exchange="WIKI"):
        ...
        try:
            ...
            stock = ticker_yf.history(period="max")
    ...
    def predict_future(self, days=30):
        ...
        file_name = 'C:\\Users\\Illia\\Documents\\Diploma_2021\\diplom_final\\utils\\img\\{0}-{1}.png'.format(
            self.symbol, datetime.datetime.now().strftime("%d-%m-%Y-%H-%M"))
        plt.savefig(file_name)
        return future, file_name
